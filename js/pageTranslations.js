...
const pageTranslations = {
  ...
  translatePrivacyInfo: 'When you translate a page, the page contents are sent to a third party\'s servers. We don\'t save your translations or use them to identify you.',
  languages: [
    {
      name: 'English',
      code: 'en'
