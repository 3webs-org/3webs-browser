export default {
  ...
  "translations": {
    ...
    "taskN": "Aufgabe %n", //this is used as a way to identify which tab a task is in "task 1", "task 2", ...
    /* custom !bangs
    ...
    "bookmarksRenameTag": "Schlagwort umbenennen",
    "bookmarksDeleteTag": "Schlagwort löschen",
    "deleteBookmarksWithTag": "Lesezeichen mit Schlagwort löschen",
    ...
    "focusModeExplanation1": "Im Fokus-Modus kann man keine neuen Tabs erstellen oder die Aufgabe wechseln.",
    "focusModeExplanation2": "Man kann den Fokus-Modus verlassen, indem man \"Fokus-Modus\" in der Menü Ansicht auswählt.",
    /* relative dates */
    ...
    "errorPagePrimaryAction": "Erneut versuchen",
    "serverNotFoundTitle": "Server nicht gefunden",
    "serverNotFoundSubtitle": "Min konnte diese Webseite nicht finden.",
    "archiveSearchAction": "Suche auf archive.org",
    "sslErrorTitle": "Diese Webseite ist nicht verfügbar",
    "sslErrorMessage": "Min konnte keine sichere Verbindung mit dieser Webseite aufbauen.",
    "dnsErrorTitle": "Webseite nicht gefunden",
    "dnsErrorMessage": "Es trat ein DNS-Fehler auf.",
    "offlineErrorTitle": "Du bist offline",
    "offlineErrorMessage": "Wieder mit dem Internet verbinden und erneut versuchen.",
    "genericConnectionFail": "Min konnte sich nicht mit dieser Webseite verbinden.",
    "sslTimeErrorMessage": "Min konnte keine sichere Verbindung mit dieser Webseite aufbauen. Bitte stelle sicher, dass deine Computeruhr korrekt eingestellt ist.",
    "addressInvalidTitle": "Diese Adresse ist ungültig.",
    "genericError": "Es trat ein Fehler auf",
    /* pages/phishing/index.html */
    "phishingErrorTitle": "Diese Seite könnte Schaden anrichten.",
    "phishingErrorMessage": "Diese Webseite könnte versuchen, persönliche Informationen wie Passwörter und Bankdaten zu stehlen.",
    "phishingErrorVisitAnyway": "Seite trotzdem besuchen",
    "phishingErrorLeave": "Seite verlassen",
    /* multiple instances alert */
    "multipleInstancesErrorMessage": "Ein Fehler ist aufgetreten. Bitte schließe alle anderen offenen Instanzen und starte neu.",
    ...
    "sessionRestoreErrorBackupInfo": "Wir haben ein Backup deiner Daten hier gespeichert: %l.", //%l will be replaced with a path to a file
    "sessionRestoreErrorLinkInfo": {
      "unsafeHTML": "Falls dieser Fehler wiederholt auftritt, bitte <a href=\"https://github.com/minbrowser/min\" target=\"_blank\">hier</a> eine neue Fehlermeldung eröffnen."
    },
    ...
    "settingsBlockedRequestCount": {
      "unsafeHTML": "Bis jetzt hat <strong></strong> Werbeanzeigen und Aktivitätsverfolgungen blockiert."
    },
    "settingsCustomBangs": "Benutzerdefinierte Bangs",
    "settingsCustomBangsAdd": "Bang hinzufügen",
    ...
    "appMenuInspectPage": "Seite überprüfen",
    ...
    "appMenuTakeTour": "Eine Tour starten",
    "appMenuViewGithub": "Auf GitHub ansehen",
    "appMenuAbout": "Über %n", //%n is replaced with app name
    "appMenuPreferences": "Einstellungen",
    ...
    "updateNotificationTitle": "Eine neue Version von ist verfügbar",
    /* Autofill settings */
    ...
    "passwordManagerSetupHeading": "Beende die Konfiguration von %p um die automatische Ausfüllfunktion zu nutzen",
    ...
    "passwordManagerSetupLinkInstaller": "Das %p Befehlszeilenschnittstelle Installationsprogramm",
    ...
    "passwordManagerBitwardenSignIn": "Um dein Bitwarden Konto zu verbinden, gehe zu vault.bitwarden.com/#/settings/account, scrolle bis zum Ende und wähle \"View API Key\". Dann kopiere die Werte in die derunterliegenden Felder.",
    "passwordManagerSetupSignIn": "Melde dich in deinem Passwortmanager an, um die automatische Ausfüllfunktion zu nutzen. Deine Zugangsdaten werden nirgendwo in gespeichert.",
    "disableAutofill": "Automatische Ausfüllfunktion deaktivieren",
    "passwordManagerSetupUnlockError": "Beim Entsperren des Passwortmanagers ist ein Fehler aufgetreten:",
    "passwordManagerSetupRetry": "Stelle sicher, dass die richtige Datei genutzt und das richtige Passwort eingegeben wurde. Ziehe das Programm wieder hierher, um es nochmal zu versuchen.",
    ...
    "savedPasswordsNeverSavedLabel": "Keine Passwortspeicherung",
