export default {
  ...
  "translations": {
    ...
    "multipleInstancesErrorMessage": "An error occurred. Please close any other open instances and restart.",
    ...
    "settingsBlockedRequestCount": {
      "unsafeHTML": "So far, has blocked <strong></strong> ads and trackers."
    },
    ...
    "settingsStartupOptions": "On start: ",
    ...
    "passwordManagerSetupSignIn": "Sign in to your password manager to start using autofill. We won't store your credentials.",
    ...
    /* Dialogs */
    "loginPromptTitle": "Sign in to %h (%r)", //%h is replaced with host, %r with realm (title of protected part of site)
