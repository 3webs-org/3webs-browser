export default {
  ...
  "translations": {
    ...
    "bookmarksRenameTag": "Renomear tag",
    "bookmarksDeleteTag": "Deletar tag",
    "deleteBookmarksWithTag": "Excluir favoritos com tag",
    ...
    "tasksSearchTabs": "Buscar abas",
    "returnToTask": "Retornar à sua tarefa anterior",
    ...
    "focusModeExplanation1": "No modo concentração, você não pode criar novas abas ou alternar tarefas.",
    ...
    "settingsDarkModeSystem": "Tema do sistema",
    ...
    "settingsStartupOptions": "Ao iniciar o Min:",
    "settingsStartupCreateTask": "Reabrir abas anteriores",
    "settingsStartupNewTaskandBackground": "Mover abas anteriores para uma tarefa em segundo plano",
    "settingsStartupNewTaskOnly": "Iniciar uma nova tarefa",
    ...
    "passwordManagerBitwardenSignIn": "Para conectar com sua conta do Bitwarden, acesse vault.bitwarden.com/#/settings/account, vá na parte inferior da página, clique em \"View API Key\". E cole os valores nos campos abaixo.",
    ...
    "passwordCaptureNeverSave": "Nunca salvar",
    /* Password viewer */
    "savedPasswordsHeading": "Senhas salvas",
    "savedPasswordsEmpty": "Nenhuma senha salva",
    "savedPasswordsNeverSavedLabel": "Nunca salvo",
